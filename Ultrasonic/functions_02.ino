...
const int ULTRASONIC_BACK_TRIG = A4;
const int ULTRASONIC_BACK_ECHO = A5;
...
void ultrasonic_setup(){
  ...
  previous_distance = get_raw_distance(ULTRASONIC_TRIG_FRONT_LEFT, ULTRASONIC_ECHO_FRONT_LEFT);
  previous_distance = get_raw_distance (ULTRASONIC_TRIG_FRONT_RIGHT, ULTRASONIC_ECHO_FRONT_RIGHT);
}
...
float get_min_distance(int ultrasonic_pin_trig_left, int ultrasonic_pin_echo_left, int ultrasonic_pin_trig_right, int ultrasonic_pin_echo_right){
    float distance_to_obstacle_front_left = get_distance(ultrasonic_pin_trig_left, ultrasonic_pin_echo_left);
    float distance_to_obstacle_front_right = get_distance(ultrasonic_pin_trig_right, ultrasonic_pin_echo_right);
    float distance_to_obstacle = min(distance_to_obstacle_front_left, distance_to_obstacle_front_right);
