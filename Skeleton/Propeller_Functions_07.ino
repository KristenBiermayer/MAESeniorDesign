...
void floor_to_wall() {
  ...
  attach_all_propeller();
  attach_all_steering();
  brushless_front.writeMicroseconds(1300);
  brushless_back.writeMicroseconds(1300);
  detach_all_propeller();
  detach_all_steering();
...
void move_up_wall() {
  brushless_front.writeMicroseconds(UP_WALL_SPEED);
  brushless_back.writeMicroseconds(UP_WALL_SPEED);
  propeller_pitch_front.write(45);
  propeller_pitch_back.write(45);
}
